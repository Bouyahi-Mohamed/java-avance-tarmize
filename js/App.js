...
import { header,post,navPagination,handlePagination,detailPost,linkUserProfile} from "./pages/index.js";
...
export default function render(posts = [], user = {}) {
  ...
  linkUserProfile(); // Attach user profile link event after rendering
}
